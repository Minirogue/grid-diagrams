...
/**
*	griddiagrams.legacy.Energy objects hold energy states for the Wang-Landau algorithm.
*	This class is designed to be updateable for new energy types.
*/
public class Energy implements Serializable {
    /**
    *	serialVersionUID used for serializing griddiagrams.legacy.Energy objects,
    ...
    */
    ...
    /**
    *	Construct the griddiagrams.legacy.Energy object from a grid diagram
    ...
    */
    ...
    /**
    *	Construct the griddiagrams.legacy.Energy object for the grid diagram resulting from a Cromwell move
    ...
    */
    ...
    /**
    * Construct the griddiagrams.legacy.Energy object from an array of energy values representing the current energy state
    ...
    */
    ...
    /**
    *	Note that this method is static, so all griddiagrams.legacy.Energy objects should use the same energyType
    ...
    */
    ...
    /**
    *	Two griddiagrams.legacy.Energy objects are equal if each of their energy values are equal
    */
    @Override
